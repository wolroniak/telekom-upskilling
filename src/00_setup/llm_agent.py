...
class LLMAgent:
    def __init__(self, model_name=None):
        ...
        self.tokenizer = self.config["tokenizer_class"].from_pretrained(self.model_name)
    ...
    def _generate_causal_chat(self, prompt, system_prompt, **kwargs):
        ...
        if "Qwen" in self.model_name:
            ...
            raise NotImplementedError(f"Causal chat for {self.model_name} is not implemented.")
